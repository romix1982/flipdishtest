...
namespace Flipdish.Recruiting.Core.Models
{
    ...
    public class MenuItemUI
    {
        ...
        private List<MenuOption> GetMenuOptions(List<OrderItemOption> previousOrderItemOptionVms)
        {
            ...
            {
                var displayOrder = 0;
                foreach (var option in previousOrderItemOptionVms.OrderByDescending(a => a.IsMasterOptionSetItem).ThenBy(a => a.MenuItemOptionSetDisplayOrder).ThenBy(a => a.MenuItemOptionDisplayOrder))
                {
